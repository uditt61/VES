  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 right-0 z-[60] h-0.5 origin-left bg-gradient-to-r from-accent-500 via-brand-600 to-brand-800"
      />

      <div className="pb-16 space-y-16 lg:space-y-24">
        <SEOHead
        ...
        <section className="relative pt-8 pb-12 overflow-hidden text-white bg-gradient-to-b from-brand-950 via-brand-900 to-brand-950 lg:pt-24 lg:pb-32">
          <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-accent-600/20 via-transparent to-transparent" />
            ...
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-12">
              ...
              >
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-800/80 border border-brand-700 text-accent-400 text-xs font-semibold backdrop-blur-sm shadow-inner">
                  ...
                  <span>
                    Admission Guidance &amp; Career Counselling &bull; Session 2026-27
                  </span>
                </div>
                ...
                <p className="max-w-2xl mx-auto text-base leading-relaxed sm:text-lg text-slate-300 lg:mx-0">
                  Explore leading recognized universities and colleges, compare job-ready degree
                  courses, and receive honest, personalized educational guidance from Vidhya
                ...
                <div className="flex flex-col items-center justify-center gap-4 pt-2 sm:flex-row lg:justify-start">
                  ...
                  >
                    <Link
                      to="/enquiry"
                      className="flex items-center justify-center w-full gap-2 text-sm font-bold text-white transition-all sm:w-auto px-7 py-3.5 rounded-2xl bg-gradient-to-r from-accent-600 to-accent-500 hover:from-accent-700 hover:to-accent-600 shadow-xl hover:shadow-accent-500/20 sm:text-base"
                    >
                  ...
                  >
                    <Link
                      to="/colleges"
                      className="flex items-center justify-center w-full gap-2 text-sm font-semibold text-white transition-colors sm:w-auto px-6 py-3.5 rounded-2xl bg-brand-800/80 hover:bg-brand-800 border border-brand-700 sm:text-base"
                    >
                ...
                <div className="grid grid-cols-3 gap-4 pt-8 text-center border-t border-brand-800/80 sm:text-left">
                  <div>
                    <p className="text-xl font-bold font-display sm:text-2xl text-accent-400">
                      100%
                    </p>
                  ...
                  <div>
                    <p className="text-xl font-bold text-white font-display sm:text-2xl">
                      0 Fee
                    </p>
                    <p className="text-xs text-slate-400 mt-0.5">
                      For Initial Counselling
                    </p>
                  </div>
                </div>
              </motion.div>
                  ...
                  <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-brand-900">
                    ...
                    <div className="absolute p-4 text-white border bottom-4 left-4 right-4 rounded-xl bg-brand-950/90 backdrop-blur-md border-brand-800/80">
                      ...
                      <p className="text-xs text-slate-300">
                        Helping students make informed, confident choices in Engineering, Nursing,
                        Management, Pharmacy &amp; Medical streams.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* ===================== 2. TRUST / VALUE ===================== */}
        <section className="relative z-20 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <motion.div
            {...motionProps(staggerContainer(0.08))}
          ...
          >
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="max-w-xl text-sm text-slate-300">
                Speak directly with an experienced career counsellor. We will review your academic
                background and recommend the best colleges tailored to your goals.
              </p>
            </div>
            ...
            <motion.button
              ...
              className="px-8 py-4 text-sm font-bold text-white transition-all shadow-lg shrink-0 rounded-2xl bg-accent-600 hover:bg-accent-700 sm:text-base hover:shadow-accent-600/30"
            >
          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            <div>
              ...
              <p className="max-w-2xl mt-2 text-sm text-slate-600">
                Explore leading universities in central India offering top-rated infrastructure,
                recognized programs, and dedicated placement cells.
              </p>
            </div>
                ...
                >
                  <div>
                    <div className="relative overflow-hidden h-44 bg-slate-100">
                      ...
                      <div className="absolute flex items-center gap-1.5 text-xs text-white bottom-3 left-3 right-3">
          ...
          >
            <div className="max-w-3xl mx-auto space-y-3 text-center">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                We help students clearly distinguish between statutory approvals, council
                recognitions, and grade accreditations before making an admission commitment.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div
                  key={item.title}
                  className="p-5 space-y-2 border rounded-2xl bg-slate-50 border-slate-100"
                >
        ...
        <section className="px-4 mx-auto space-y-12 max-w-7xl sm:px-6 lg:px-8">
          ...
          <motion.div
            {...motionProps(staggerContainer(0.1))}
            ...
            {[
              {
                ...
                desc: 'Tell us about your qualification, preferred stream, location, and career goals.',
              },
              {
                step: '02',
                title: 'Free Counselling',
                desc: 'Our senior counsellor compares approved institutions matching your budget and aspirations.',
              },
              {
                step: '03',
                title: 'Eligibility Check',
                desc: 'We verify your academic marksheets and guide you through quota and scholarship options.',
              },
              {
                step: '04',
                title: 'Confirmed Admission',
                desc: 'Direct assistance with application submission, seat allotment, and hostel guidance.',
              },
            ].map((item) => (
              <motion.div
                key={item.step}
          ...
          <div className="px-4 mx-auto space-y-10 max-w-7xl sm:px-6 lg:px-8">
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
              <div className="space-y-2">
                ...
                <p className="max-w-xl text-sm text-slate-300">
                  Giving back to society through free educational profiling, rural awareness
                  camps, and scholarship assistance for underserved students.
                </p>
              </div>
        ...
        <section className="max-w-4xl px-4 mx-auto space-y-8 sm:px-6 lg:px-8">
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-slate-600">
              Common questions students and parents ask regarding admission procedures and our
              counselling.
            </p>
          </div>
          ...
          >
            <div className="max-w-2xl mx-auto space-y-3">
              ...
              <p className="text-sm leading-relaxed sm:text-base text-slate-300">
                Don't navigate complex university applications alone. Our experienced counsellors
                are ready to support your admission application today.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              >
                <Link
                  to="/enquiry"
                  className="flex items-center justify-center w-full px-8 py-4 text-sm font-bold text-white transition-all shadow-xl sm:w-auto rounded-2xl bg-accent-600 hover:bg-accent-700 sm:text-base"
                >
              ...
              >
                <Link
                  to="/contact"
                  className="flex items-center justify-center w-full py-4 text-sm font-semibold text-white transition-colors border sm:w-auto px-7 rounded-2xl bg-white/10 hover:bg-white/20 sm:text-base border-white/20"
                >
                  Contact Our Office
                </Link>
              </motion.div>
